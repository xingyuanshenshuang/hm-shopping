<template>
  <div class="prodetail">
    ...
    <van-swipe :autoplay="3000" @change="onChange">
      <van-swipe-item
        v-for="(image, index) in detail.goods_images"
        :key="index"
      >
    ...
    <div class="comment">
      ...
      <div class="comment-list">
        ...
        >
          <div class="top">
            <img :src="item.user.avatar_url || imgSrcDefault" alt="" />
...
import imgSrcDefault from '@/assets/default-avatar.png'
...
export default {
  ...
  methods: {
    ...
    async getProComments () {
      const {
        data: { list, total }
      } = await getProComments(this.goodsId, this.limit)
